...
public class VentanaBuscaMateria extends JFrame implements ActionListener, WindowListener {
    ...
    public VentanaBuscaMateria(DataBase db) {
        this.db = db;
        this.setTitle("Busca Materia");
    ...
    public void muestraFilas() {
        ...
        rs=db.ejecutaConsulta("SELECT * from materia order by ID_materia");
        try {
            while (rs.next()) {
